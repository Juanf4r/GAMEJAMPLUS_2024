        ...
        public void Construct(ref VoronoiDiagram voronoiDiagram, Rect bounds)
        {
            ...
            switch (Mode)
            {
                case VoronoiBuilderMode.DelaunayDual:
                    ...
                    voronoiDiagram.Vertices.AddRange(Vertices.AsArray());
                    voronoiDiagram.Edges.AddRange(Edges.AsArray());
                    break;

                case VoronoiBuilderMode.BruteForce:
                    CreateVoronoiDiagram(ref voronoiDiagram, Sites.AsArray(), bounds);
                    break;
            }
